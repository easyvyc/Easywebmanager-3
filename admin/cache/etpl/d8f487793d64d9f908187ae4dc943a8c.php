...
<?php if(!$templateVariables->vars["superadmin"]){ ?>
<style>
...
if(location.hash=='#delete'){
	if(confirm('<?php echo $templateVariables->vars["phrases.common.delete_confirm"]; ?>')) location = "main.php?content=mod&page=column_list&id=<?php echo $templateVariables->vars["module_id"]; ?>&action=delete&deleteid=<?php echo $templateVariables->vars["data.id"]; ?>";
}
</script>