...
<div style="width:100%;">
	...
	<tr>
		<td height="30" valign="middle"><a href="main.php?content=settings&page=edit_column&module_id={module_id}&id=0" class="path"><img src="images/new_element.gif" border="0" align="absmiddle"> {phrases.settings.module.new_column}</a></td>
	</tr>
