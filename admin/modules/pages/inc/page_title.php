...
if($this->elements['generate_page_title']['value']==1 || $this->elements['isNew']['value']==1){
	$v['editorship'] = 0;
}else{
	$v['editorship'] = 1;
}

if($this->elements['isNew']['value']==1 && strlen($v['value'])>0 && $this->elements['generate_page_title']['value']==0){
	$v['editorship'] = 1;
}
