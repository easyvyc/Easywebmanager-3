...
if($item_data['isNew']!=1){
	$form->formAction = "ajax.php?get={$_GET['content']}/actions&action=edit&content={$_GET['content']}&module={$record->module_info['table_name']}&id={$_GET['id']}&parent_id={$_GET['id']}&new=0";
}else{
	$form->formAction = "ajax.php?get={$_GET['content']}/actions&action=edit&content={$_GET['content']}&module={$record->module_info['table_name']}&id={$_GET['id']}&parent_id={$_GET['parent_id']}&new=1";	
}
