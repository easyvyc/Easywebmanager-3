<div id="area_id_{elm.name}" class="formElementsField{block elm.edited} edited{-block elm.edited}">
	...
	<div class="e">
		...
		<input type="button" value=" Auto " class="fo_submit" onclick="javascript: get_page_keywords(event, '{config.site_url}', '{elm.name}', {data.id.value})" />
		
<script type="text/javascript"> 
var no_keywords_found_on_page = '{phrases.pages.no_keywords_found_on_page}'; 
var keywords_exist_on_page='{phrases.pages.keywords_exist_on_page}'; 
</script>
