...
<div style="width:100%;">
	...
	<div style="padding-top:10px;padding-bottom:10px;">
		...
		<script type="text/javascript">
			...
			if(location.hash=='#{mod_actions.name}') PageClass.getPageContent_action('{config.site_admin_url}ajax.php?get={get.content}/actions&action={mod_actions.name}&content={get.content}&module={module.table_name}&id={get.id}', 'EDIT_area__action', '{mod_actions.name}');
			</loop name="mod_actions">
