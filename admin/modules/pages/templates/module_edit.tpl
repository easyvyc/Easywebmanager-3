<table border="0" cellpadding="5" cellspacing="0" width="100%" align="left">
	...
	<a href="main.php?content={get.content}&module={module.table_name}&page={filter_page}edit&id={get.id}&record_id=0&parent_id={get.id}&ce=1&new=1" class="path"><img src="images/new_element.gif" border="0" align="absmiddle"> {phrases.catalog.new_element}</a>
	</block name="is_category">
	<block name="is_category" no>
	<a href="main.php?content={get.content}&module={module.table_name}&page={filter_page}edit&id={get.id}&record_id=0&parent_id={get.id}&ce=0&new=1" class="path"><img src="images/new_element.gif" border="0" align="absmiddle"> {phrases.catalog.new_element}</a>	
	</block name="is_category" no>
	
	<block name="data.isNew" no>
	&nbsp;&nbsp;&nbsp;<a href="javascript: if(confirm('{phrases.common.delete_confirm}')){ window.location = 'main.php?content={get.content}&module={module.table_name}&page=files&action=delete&deleteid={data.id}&id={get.id}'; }"><img src="images/delete.gif" border="0" align="absmiddle">&nbsp;&nbsp;{phrases.common.delete_title}</a>
	</block name="data.isNew" no>
