...
parent.PageClass.getPageContent_action('{config.site_admin_url}ajax.php?get=pages/actions&action=block&content=pages&module={module.table_name}&page_id={get.page_id}&area={get.area}', 'EDIT_area__action', 'edit');
</script>
</block name="success">