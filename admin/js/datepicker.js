    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             ...
             scwArrWeekInits        = ['Sun','Mon','Tue','Wen','Thu','Fri','Sam'];
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #9d9d9d;}'  +
            '/* Drag Handle */'                                         +
...
// ****************************************************************************
    ...
    function scwShow(scwEle,scwSource,callAfter)
            ...
            {scwSelYears.options.selectedIndex=Math.floor(scwMonthSum/12);
             ...
             function scwSetOutput(scwOutputDate){
                ...
                if (typeof scwTargetEle.value == 'undefined'){
                	...
                	if(scwTargetEle.onchange) scwTargetEle.onchange();
                }
                scwHide();
