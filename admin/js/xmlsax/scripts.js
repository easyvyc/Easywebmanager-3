...
function startSaxParser(ixml) {
    ...
    ************************************************************************************/
	...
	data = {"xmlText":xmlTextArray, "xmlCData":xmlCDataArray, "xmlAttr":xmlAttrArray, "xmlPath":xmlPathArray};
	
	/*alert(data.xmlPath.length);
	for(i=0; i<data.xmlPath.length; i++){
		alert(data.xmlPath[i]);
	}*/
