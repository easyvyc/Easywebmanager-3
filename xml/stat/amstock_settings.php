...
foreach($_GET['stats'] as $val){
	$stat_lines[] = array('title'=>$cms_phrases['main']['stat'][$val.'_visitors'], 'stat'=>$val);
}

//$stat_lines[] = array('title'=>$cms_phrases['main']['stat']['referer_visitors'], 'stat'=>'referer');
...
<settings>
  ...
  <data_sets> 
    ...
    <?php foreach($stat_lines as $i=>$val){ ?> 
    <data_set did="<?php echo $i; ?>">
       ...
       <file_name><?php echo $configFile->variable['site_url']; ?>xml.php?get=<?php echo $_GET['datafile']; ?>&stat=<?php echo $val['stat']; ?></file_name>
       ...
       <main_drop_down selected="<?php echo ($_GET['stat']==$val['stat']?"true":"false"); ?>"></main_drop_down> 	    	  
  ...
  <period_selector>
    ...
    -->
    	...
    	<period type="MM" count="1" selected="true">1M</period>
  ...
  <strings>    
    ...
    <duration_units>    
 	...
 	<months>  
  		<jan><?php echo $cms_phrases['main']['common']['months'][1]; ?></jan>
    	<feb><?php echo $cms_phrases['main']['common']['months'][2]; ?></feb>
    	<mar><?php echo $cms_phrases['main']['common']['months'][3]; ?></mar>
    	<apr><?php echo $cms_phrases['main']['common']['months'][4]; ?></apr>
    	<may><?php echo $cms_phrases['main']['common']['months'][5]; ?></may>
    	<jun><?php echo $cms_phrases['main']['common']['months'][6]; ?></jun>
    	<jul><?php echo $cms_phrases['main']['common']['months'][7]; ?></jul>
    	<aug><?php echo $cms_phrases['main']['common']['months'][8]; ?></aug>
    	<sep><?php echo $cms_phrases['main']['common']['months'][9]; ?></sep>
    	<oct><?php echo $cms_phrases['main']['common']['months'][10]; ?></oct>
    	<nov><?php echo $cms_phrases['main']['common']['months'][11]; ?></nov>
    	<dec><?php echo $cms_phrases['main']['common']['months'][12]; ?></dec>    
  	</months>
