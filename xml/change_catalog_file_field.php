...
if($_SESSION['admin']['user_ip']!=$_SERVER['REMOTE_ADDR'] || !isset($_SESSION['admin']['permission'])){
...
// Settings
	...
	$extension_blacklist = array("exe", "php", "inc", "phtml", "html", "js", "htm", "pl", "py");	// Denied file extensions
...
// Process the file
	...
	*/
	...
	$_FILES["file_".$_POST['column']] = $_FILES[$upload_name];
	$_GET['module'] = $_POST['module'];
	$_GET['column'] = $_POST['column'];
	$_GET['id'] = $_POST['id'];
	$_GET['lng'] = $_POST['lng'];
	$_GET['old_'.$_POST['column']] = $_POST['old'];
	
	include(AJAXDIR."change_catalog_item_field.php");
	
	echo $item_data[$_GET['column']];
